...
export const updateTemplateLikes = async (templateInfo) => {
    const templateInfoBody = {
        templateId: templateInfo.templateId.toString(),
        userId: templateInfo.userId,
        liked: templateInfo.liked
    }
    const action = "updateTemplateLikes";
    const body = {
        templateInfoBody,
        action
    }
